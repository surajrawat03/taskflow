        ...
        <div class="p-6">
            <form action="{{ route('tasks.update', $task->id) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="is_completed" id="is_completed" {{ old('is_completed', $task->is_completed) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                    ...
                    <div class="flex justify-end space-x-3">
                        <a href="{{ route('tasks.show', $task->id) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Cancel
                        </a>
