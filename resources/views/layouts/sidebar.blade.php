<div x-data="{ open: false }" 
    ...
    <div class="overflow-y-auto h-[calc(100vh-4rem)]">
        <nav class="px-2 py-4 space-y-1">
            ...
            <a href="{{ route('tasks') }}" class="flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('tasks.*') ? 'bg-indigo-100 text-indigo-700' : 'text-gray-700 hover:bg-gray-100' }}">
            ...
            <a href="#" class="flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('projects.*') ? 'bg-indigo-100 text-indigo-700' : 'text-gray-700 hover:bg-gray-100' }}">
            ...
            <a href="#" class="flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('team') ? 'bg-indigo-100 text-indigo-700' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5 mr-2 {{ request()->routeIs('team') ? 'text-indigo-500' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
