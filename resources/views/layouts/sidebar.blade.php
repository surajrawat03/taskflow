<div x-data="{ open: false }" 
    ...
    <div class="overflow-y-auto h-[calc(100vh-4rem)]">
        <nav class="px-2 py-4 space-y-1">
            ...
            <a href="{{ route('teams.index') }}" class="flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('team') ? 'bg-indigo-100 text-indigo-700' : 'text-gray-700 hover:bg-gray-100' }}">
