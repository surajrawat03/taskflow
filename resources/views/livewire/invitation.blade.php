<div>
    <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="relative">
            <input type="text" wire:model.debounce.300ms="search" placeholder="Search team members..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Get started by inviting team members to your project.
                            </p>
                            <div class="mt-6">
                                <button type="button" 
        wire:click="$emit('openModal')"
